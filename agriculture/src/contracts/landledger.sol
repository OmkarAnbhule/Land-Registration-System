...
contract landledger {
    ...
    function registerUser(string memory _name, string memory _date, string memory ,string memory _aadharNumber, string memory _panNumber, string memory _email
    ) public {
        ...
        UserMapping[msg.sender] = User(msg.sender, _name, _date,_aadharNumber,_panNumber,_email,false);
